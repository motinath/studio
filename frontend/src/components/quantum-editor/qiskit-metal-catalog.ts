...
export const QISKIT_CATALOG: QiskitComponent[] = [
  // ───────────── Qubits ─────────────
  {
    ...
    defaultParams: { JJ_pad_lower_width: "25um", JJ_pad_lower_height: "10um", finger_lower_width: "1um", _uiScale: 10 },
    pins: [],
  ...
  },
  {
    ...
    defaultParams: { JJ_pad_width: "25um", JJ_pad_height: "10um", finger_width: "1um", _uiScale: 10 },
    pins: [],
  ...
  },
  {
    ...
    defaultParams: { loop_width: "20um", loop_height: "20um", _uiScale: 8 },
    pins: [],
  ...
  // ───────────── Couplers ─────────────
  {
    ...
    defaultParams: { prime_width: "10um", prime_gap: "6um", finger_length: "40um", _uiScale: 4 },
  ...
  },
  {
    ...
    defaultParams: { prime_width: "10um", prime_gap: "6um", coupling_length: "100um", _uiScale: 4 },
    pins: ["prime_start", "prime_end", "second_end"],
  ...
  },
  {
    ...
    defaultParams: { prime_width: "10um", prime_gap: "6um", t_length: "30um", _uiScale: 5 },
    pins: ["prime_start", "prime_end", "second_end"],
    tags: ["coupler", "tee"],
  },
  {
  ...
  // ───────────── Terminations ─────────────
  {
    ...
    defaultParams: { pad_width: "200um", pad_height: "100um", lead_length: "25um", _uiScale: 2.5 },
    pins: ["tie"],
  ...
  },
  {
    ...
    defaultParams: { pad_width: "200um", pad_height: "100um", coupling_gap: "5um", _uiScale: 2.5 },
    pins: ["tie"],
  ...
  },
  {
    ...
    defaultParams: { pad_width: "200um", pad_height: "100um", _uiScale: 2.5 },
    pins: ["tie"],
  ...
  },
  {
    ...
    defaultParams: { width: "10um", gap: "6um", _uiScale: 8 },
    pins: ["open"],
  ...
  },
  {
    ...
    defaultParams: { width: "10um", _uiScale: 8 },
    pins: ["short"],
  ...
  // ───────────── Lumped elements ─────────────
  {
    ...
    defaultParams: { finger_length: "65um", finger_count: 3, cap_gap: "6um", _uiScale: 5 },
    pins: ["a", "b"],
  ...
  },
  {
    ...
    defaultParams: { finger_length: "40um", finger_count: 5, cap_gap: "6um", _uiScale: 5 },
    pins: ["a", "b"],
  ...
  },
  {
    ...
    defaultParams: { length: "7mm", trace_width: "10um", trace_gap: "6um", _uiScale: 3 },
    pins: ["in", "out"],
